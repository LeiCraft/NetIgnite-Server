...
interface SchemaBaseOptions<T extends SchemaType> {
    primaryKey?: boolean;
...
interface SchemaConfig<T extends SchemaType> extends SchemaBaseOptions<T> {
    type: T;
};
...
namespace ST {
    ...
    export function boolean(options: SchemaBaseOptions<"boolean"> = {}): SchemaConfig<"boolean"> {
        return {
            type: "boolean",
            allowNull: false,
            ...options
